...
<head>
    ...
    <title>GymGanized - Perfil</title>
    <link rel="shortcut icon" href="Img-gg/logo-1.png">
</head>
<body class="bg-no-repeat bg-cover bg-center " style="background-image: url('{{ asset('Img-gg/f-2.avif') }}');">
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="flex justify-between items-center py-6">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('funcion') }}" class="text-white hover:text-green-500 font-semibold">ACERCA DE NOSOTROS</a>
                <a href="{{ route('guia') }}" class="text-white hover:text-green-500 font-semibold">DESCARGAR APP</a>
...
<form method="POST" action="{{ route('logout') }}">
    ...
    <div class="hidden mobile-menu">
        <ul>
            ...
            <li><a href="{{ route('funcion') }}" class="block text-center py-4 px-8 font-medium text-lg text-white hover:bg-green-500 transition duration-300">ACERCA DE NOSOTROS</a></li>
            <li><a href="{{ route('funcion') }}" class="block text-center py-4 px-8 font-medium text-lg text-white hover:bg-green-500 transition duration-300">DESCARGAR APP</a></li>
...
<script>
  ...
  <!-- Body -->
      ...
      <div class="mt-24">
        ...
        <div class="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadophp artisan migraw-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
            <div class="pb-6">
              <div class="flex flex-wrap justify-center">
                  <div class="flex justify-center w-full">
                      <div class="relative">
                          <img src="{{ asset('images/' .Auth::user()->url) }}" class="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 min-w-[150px] min-h-[150px] max-w-[150px] max-h-[150px]" />
                      </div>
                  </div>
              </div>
              <div class="mt-2 mt-20 text-center">
                  <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">{{ auth()->user()->username }}</h3>
                  <div class="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                      
                          <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
                      </svg>
                      <!-- /typography/_h3.antlers.html -->
                      <div class="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">{{ auth()->user()->name }}</div>
          ...
          <a href="{{ route('config_user') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
        Settings
      </a>
      </div>
    </div>
