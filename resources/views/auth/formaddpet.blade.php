...
<head>
    ...
    <link rel="shortcut icon" href="Img-gg/favi.png">
...
<body class="bg-no-repeat bg-cover bg-center " style="background-image: url('{{ asset('img/fond2.jpg') }}');">
    <nav class="bg-white shadow-lg">
        ...
        <div class="flex justify-between">
            ...
            <div>
                ...
                <img src="img/perro.png" alt="Logo" class="h-8 w-8 mr-2" />
            ...
            <div class="hidden md:flex items-center space-x-1">
                <a
                href="{{ route('mascotas') }}"
                class="py-4 px-2 text-gray-500 font-semibold hover:text-pink-600 transition duration-300"
                >Mascotas</a
                >
                <a
                href="{{ route('funcion') }}"
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button class="py-4 px-2 text-gray-500 font-semibold hover:text-pink-600 transition duration-300" type="submit">Cerrar session</button>
                </form>
            ...
            <div class="hidden md:flex items-center space-x-3">
                <a
                    ...
                    class="py-2 px-2 font-medium text-white bg-pink-600 rounded hover:bg-pink-400 transition duration-300"
                    >Usuario</a
                >
                </div>
            <!-- Mobile menu button -->
            ...
            <button class="outline-none mobile-menu-button">
                <svg
                class="w-6 h-6 text-gray-500 hover:text-pink-600"
                x-show="!showMenu"
                fill="none"
        ...
        <ul>
            <li><a href="{{ route('mascotas') }}"
                class="block text-center px-2 py-4 hover:bg-pink-600 transition duration-300">Mascotas</a></li>
            <li><a href="{{ route('funcion') }}" class="block text-center px-2 py-4 hover:bg-pink-600 transition duration-300">¿Como
            funciona?</a>
            </li>
            <li><a href="{{ route('guia') }}" class="block text-center px-2 py-4 hover:bg-pink-600 transition duration-300">Guia de
            cuidado</a></li>

            <li><a href="{{ route('posts.index') }}" class="block text-center px-2 py-4 hover:bg-pink-600 transition duration-300">Usuario</a>
            </li>
            <li><form method="POST" action="{{ route('logout') }}">
                @csrf
                <button class="block text-sm  w-full py-4 hover:bg-pink-600 transition duration-300" type="submit">Cerrar session</button>
            </form>
            </li>
        </ul>
        </div>
		...
		<div class="flex justify-center px-6 my-12">
			...
			<div class="w-full xl:w-3/4 lg:w-11/12 flex">
				...
				<div
					...
					style="background-image: url('https://img.freepik.com/foto-gratis/perro-sacando-lengua-mirando-al-fotografo_23-2148366946.jpg?w=740&t=st=1682889384~exp=1682889984~hmac=41aec56c4746d14cd0e2276f0130cf5e60f98ad837ac977b8ebdc7ad02b2fd9d')"
				></div>
				<!-- Col -->
				<div class="w-full lg:w-7/12  p-5 rounded-lg lg:rounded-l-none bg-amber-400">
					<h3 class="pt-4 text-2xl text-center">Actualizacion de datos</h3>
					<form class="px-8 pt-6 pb-8 mb-4  rounded" method="POST" action="{{ route('addpet.store') }}" enctype="multipart/form-data">
					@csrf
						...
						<div class="mb-4">
							<label class="block mb-2 text-sm font-bold text-gray-700" for="email">
								...
								<select name="tipo" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium " placeholder="Raza">
									...
									<option	option  value="Tortuga">Tortuga</option>
						...
						<div class="mb-4">
							...
							<input type="number" id="anio" name="edad" min="1" max="20"  
						class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
								placeholder="Edad">
						</div>
						<div class="mb-4">
							...
							<select id="genero" name="genero" placeholder="Genero de la mascota" class="flex justify-start items-center text-truncate rounded-lg bg-white pl-4 pr-6 py-3 shadow-sm form-radio focus:outline-none focus:shadow-outlin">
			<option value="">Opcion</option>
			<option value="Hombre" class="select-none text-gray-700">Macho</option>
			<option value="Hembra" class="select-none text-gray-700">Hembra</option>
			</select>
						</div>
						<div class="mb-4">
							...
							class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
								...
								type=""
								placeholder="Descripcion de tu amigo"
							/>
						</div>
					<div class="mb-4 md:flex md:justify-between">
							<div class="mb-4 md:mr-2 md:mb-0">
								...
								type="file" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" multiple accept="image/*"/>
						</div>
    ...
    <footer aria-label="Site Footer" class="bg-gray-100">
        <div class="mx-auto max-w-5xl px-4  sm:px-6 lg:px-8">
          ...
          <nav aria-label="Footer Nav" class="mt-12">
            <ul class="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
              <li>
                <a class="text-gray-700 transition hover:text-gray-700/75" href="{{ route('funcion') }}">¿Como funciona?</a>
              </li>
              <li>
                <a class="text-gray-700 transition hover:text-gray-700/75" href="{{ route('guia') }}">Guia</a>
              </li>
              <li>
                <a class="text-gray-700 transition hover:text-gray-700/75" href="/">Contacto</a>
              </li>
              <li>
                <a class="text-gray-700 transition hover:text-gray-700/75" href="{{ route('mascotas') }}">Mascotas</a>
              </li>
          </nav>
        ...
        <div class="mx-auto max-w-5xl px-4 py-3 sm:px-6 lg:px-8">
            ...
            Derechos reservados a ©Colegio Don Bosco.
            </p>
        </div>
    </footer>
</body>
