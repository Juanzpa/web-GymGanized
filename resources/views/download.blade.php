...
<script>
  ...
  btn.addEventListener("click", () => {
    ...
    <section class="py-24 ">
    <div class="px-4 mx-auto overflow-hidden bg-gray-500  max-w-7xl sm:px-6 lg:px-8">
        <div class="py-10 sm:py-16 lg:py-24 2xl:pl-24">
            <div class="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20">
                <div>
                    <h2 class="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl lg:leading-tight">¡Descarga <span style="color: #B0EE3C;"> GymGanized</span>! </h2>
                    <p class="mt-4 text-xl text-gray-50">¿Estás listo para llevar tus entrenamientos al siguiente nivel?</p>
                    <p class="mt-4 text-xl text-gray-50"> ¡No busques más! <span style="color: #B0EE3C;"> GymGanized</span> es tu compañero de entrenamiento personalizado que te ayudará a alcanzar tus metas de fitness de manera eficiente y divertida.</p>

                    <div class="flex flex-row items-center mt-8 space-x-4 lg:mt-12 ">
                        <a download="GymGanized" href="Img-gg/app-release.apk">
                ...
                <div class="relative px-12">
                    <svg class="absolute inset-x-0 bottom-0 left-1/2 -translate-x-1/2 -mb-48 lg:-mb-72  w-[460px] h-[460px] sm:w-[600px] sm:h-[600px]" fill="currentColor" viewBox="0 0 8 8" style="color: #B0EE3C;">
                        <circle cx="4" cy="4" r="3" />
                    </svg>
                    <img class="relative w-full  mx-auto  lg:-mb-64" src="{{ asset('img-gg/phone.png') }}" alt=""/>
                </div>
            </div>
        </div>
    </div>
