        ...
        <div class="flex justify-center px-6 my-12">
            ...
            <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                ...
                <div
                    ...
                    style="background-image: url('https://images.unsplash.com/photo-1658193447990-dcf864d0451a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDJ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60')"
                ></div>
                <!-- Col -->
                <div class="w-full lg:w-7/12  p-5 rounded-lg lg:rounded-l-none bg-amber-400">
                    <h1 class="text-2xl text-white bg-pink-600 p-10 font-bold sm:text-3xl text-center">Formulario de adopcion</h1>
                    
                    <form class="px-8 pt-6  mb-4 rounded" action="{{ route('contacto.enviar') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <br>
                            <div class="mb-4 md:mr-2 md:mb-0">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="correo">
                                Correo Electronico
                                </label>
                                <input
                                class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <div class="mb-4 md:mr-2 md:mb-0">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="telefono">
                                Numero telefonico
                                </label>
                                <input
                                class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 text-sm font-bold text-gray-700" for="mensaje">
                                Mensaje para el propietario de la mascota
                            </label>
                            <input
                            class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                        ...
                        <div class="mb-6 text-center">
                            <button
                                class="w-full px-4 py-2 font-bold text-white bg-pink-600 rounded-full hover:bg-pink-800 focus:outline-none focus:shadow-outline"
                                type="submit"
                            >
                                Enviar Correo
                            </button>
