...
<body class="bg-gray-800">
  <div class="w-full m-0 p-0 bg-cover bg-bottom  " style="background-image:url({{ asset('img/coverr.jpg') }}); height: 25vh; max-height:460px;">
  </div>
  
  <!--Container-->
  <div class="container px-4 md:px-0 max-w-6xl mx-auto -mt-32 mb-10">
    
    <div class="mx-0 sm:mx-6">
      

      <div class=" w-full text-xl md:text-2xl  leading-normal rounded-t">
        
      <!--Lead Card-->
      <div class="flex h-full bg-white rounded overflow-hidden shadow-lg">
        <a href="{{ route('vacunacion') }}" class="flex flex-wrap no-underline hover:no-underline">
          <div class="w-full md:w-2/3 rounded-t">	
            <img src="https://img.freepik.com/foto-gratis/mujer-bebiendo-agua-despues-ejercicio_23-2149240213.jpg?size=626&ext=jpg&ga=GA1.2.1947279272.1693252669&semt=sph" class="h-full w-full shadow">
          </div>

          <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-gray-100 rounded-t rounded-b-none overflow-hidden shadow-lg">
              <p class="w-full text-xs md:text-lg text-center pt-6 px-6 font-bold" style="color: #B0EE3C;">Mantén tu Cuerpo Hidratado y Vital

              </p>
                              <br>
              <div class="w-full font-bold text-xl text-black text-center px-6" >HIDRATACIÓN SALUDABLE</div>
                              <br>
              <p class="text-black font-serif text-base text-justify px-6 mb-3">
                La hidratación es esencial para mantener nuestro cuerpo funcionando correctamente. No solo es importante para la salud física, sino también para el bienestar general. En este artículo, exploraremos la importancia de la hidratación, cómo saber si estás hidratado adecuadamente y consejos prácticos para mantener tu cuerpo en equilibrio....
              </p>
            </div>

            <div class="flex-none mt-auto rounded-b rounded-t-none overflow-hidden shadow-lg p-6" style="background-color: #B0EE3C;">
              <div class="flex items-center justify-between">
                <p class="text-gray-800 text-xs md:text-sm font-bold">CONTINUAR LEYENDO</p>
              </div>
            </div>
          </div>
        </a>
      ...
      <div class="flex flex-wrap justify-between pt-12 -mx-6">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-gray-100 rounded-t rounded-b-none overflow-hidden shadow-lg">
            <a href="{{ route('cuidados') }}" class="flex flex-wrap no-underline hover:no-underline">
              <img src="https://img.freepik.com/foto-gratis/mujer-sujetando-cuerda-gimnasio_23-2147675214.jpg?w=900&t=st=1693284029~exp=1693284629~hmac=be4203863632e3e5bcbf653d1c410cd84a362e61fc7cf2e65ec795f6e68036db" class="h-full w-full rounded-t pb-6">
              <p class="w-full text-xs md:text-lg text-center pt-6 pb-6 px-4 font-bold" style="color: #B0EE3C;" >DESCUBRIENDO LA IMPORTANCIA DE LAS RUTINAS DE EJERCICIO</p>
                              <br>
              <div class="w-full font-bold text-xl text-black text-center px-6" >ALCANZA TU POTENCIAL</div>
                              
              <p class="text-black font-serif text-base text-justify px-6 mt-5 mb-3">
                En medio del ajetreo y el bullicio de la vida moderna, a menudo encontramos nuestras agendas repletas de compromisos, lo que puede hacer que encontrar tiempo para el ejercicio parezca una hazaña imposible. Sin embargo, el valor de incorporar rutinas de ejercicio en nuestra vida...
              </p>
            </a>
          </div>
          <div class="flex-none mt-auto rounded-b rounded-t-none overflow-hidden shadow-lg p-6" style="background-color: #B0EE3C;">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-gray-100 rounded-t rounded-b-none overflow-hidden shadow-lg">
            <a href="{{ route('adaptarse') }}" class="flex flex-wrap no-underline hover:no-underline">
              <img src="https://img.freepik.com/foto-gratis/tazones-granola-yogur-frutas-bayas-sobre-superficie-blanca_181624-26974.jpg?w=900&t=st=1693284254~exp=1693284854~hmac=0a3f7cebb92c115818266edb97163afb9726d680f30c7aac59741842d1949fc3" class="h-full w-full rounded-t pb-6">
              <p class="w-full text-xs md:text-lg text-center pt-6 pb-6 px-4 font-bold" style="color: #B0EE3C;">DESCUBRIENDO LOS FUNDAMENTOS DE UNA BUENA ALIMENTACIÓN</p>
                              <br>
              <div class="w-full font-bold text-xl text-black text-center px-6" >NUTRICIÓN INTELIGENTE</div>
                  
              <p class="text-black font-serif text-base text-justify px-6 mt-5 mb-3">
                En un mundo lleno de información contradictoria sobre la alimentación, es esencial comprender los fundamentos de una buena nutrición. En este blog, exploraremos los principios clave para lograr una alimentación equilibrada y cómo tomar decisiones inteligentes...
              </p>
            </a>
            </div>
          <div class="flex-none mt-auto rounded-b rounded-t-none overflow-hidden shadow-lg p-6" style="background-color: #B0EE3C;">
            <div class="flex items-center justify-between">
              <p class="text-gray-800 text-xs md:text-sm tex font-bold">CONTINUAR LEYENDO</p>
            </div>
          </div>
        </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-gray-100 rounded-t rounded-b-none overflow-hidden shadow-lg">
            <a href="{{ route('enfermo') }}" class="flex flex-wrap no-underline hover:no-underline">
              <img src="https://img.freepik.com/fotos-premium/pierna-femenina-pisando-balanzas-cinta-metrica_53476-3874.jpg?size=626&ext=jpg&ga=GA1.1.1947279272.1693252669&semt=sph" class="h-full w-full rounded-t pb-6">
              <p class="w-full text-xs md:text-lg text-center pt-6 pb-6 px-4 font-bold" style="color: #B0EE3C;">Comprendiendo el vínculo entre edad y peso corporal</p>
                              <br>
              <div class="w-full font-bold text-xl text-black text-center px-6" >PESO SEGÚN LA EDAD</div>
                              
              <p class="text-black font-serif text-base text-justify px-6 mt-5 mb-3">
                ¡Bienvenidos a un análisis enriquecedor! En este recorrido, exploraremos la estrecha relación entre la edad y el peso corporal. A lo largo de las distintas etapas de la vida, el peso puede experimentar variaciones notables debido a diversos factores. Desde la infancia hasta la adultez mayor...
              </p>
            </a>
          </div>
          <div class="flex-none mt-auto rounded-b rounded-t-none overflow-hidden shadow-lg p-6" style="background-color: #B0EE3C;">
