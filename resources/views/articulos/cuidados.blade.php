...
<script>
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center pt-12 pb-2">
            <a class="font-bold uppercase hover:text-gray-700 text-5xl" style="color: #B0EE3C" href="#">
              ALCANZA TU POTENCIAL
            </a>
            <p class="text-lg text-white">
              DESCUBRIENDO LA IMPORTANCIA DE LAS RUTINAS DE EJERCICIO
            </p>
        </div>
    </header>
    ...
    <div class="container  mx-auto flex flex-wrap py-6">
      ...
      <section class="w-full md:w-2/3 flex flex-col items-center px-3">
          ...
          <article class="flex flex-col shadow my-4">
              ...
              <a href="#" class="hover:opacity-75">
                  <img class="w-full h-full" src="https://img.freepik.com/foto-gratis/senora-activa-haciendo-ejercicio-piernas-estera-fitness-purpura_197531-16671.jpg?w=1380&t=st=1693276014~exp=1693276614~hmac=b2fbb2caf3d25694f541b0991df1636926f3951ea1eb997a75e31e2016dc4ab8">
              </a>
              <div class="bg-gray-900 flex flex-col justify-start p-6">
                 ...
                 <p href="#" class="text-sm pb-8">
                  ...
                  <p class="pb-3 text-justify text-white">En medio del ajetreo y el bullicio de la vida moderna, a menudo encontramos nuestras agendas repletas de compromisos, lo que puede hacer que encontrar tiempo para el ejercicio parezca una hazaña imposible. Sin embargo, el valor de incorporar rutinas de ejercicio en nuestra vida diaria es incalculable. Más allá de moldear nuestra apariencia física, el ejercicio tiene profundas implicaciones para nuestra salud mental, bienestar general y calidad de vida. En este artículo, exploraremos en detalle cómo el ejercicio beneficia tanto a nuestro cuerpo como a nuestra mente, y proporcionaremos ideas prácticas para hacer que el ejercicio forme parte esencial de tu rutina diaria.</p>
                  <br>
                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>El Cuerpo Fuerte y Saludable </b></h1>
                  <p class="pb-3 text-justify text-white">El ejercicio regular es una inversión en tu salud física. No se trata solo de esculpir tu cuerpo, sino de mejorar tus funciones internas y fortalecer tu sistema en general. Cuando te comprometes a una rutina de ejercicios constante, te beneficias en múltiples formas:</p><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Mejora de la Resistencia Cardiovascular: </b>Los ejercicios aeróbicos, como correr, nadar o andar en bicicleta, mejoran la capacidad de tu corazón y pulmones para suministrar oxígeno a tus músculos. Esto te permite realizar actividades diarias con menos fatiga.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Fortalecimiento Muscular:</b> Una de las piedras angulares para mantener una hidratación óptima es consumir agua de manera constante a lo largo del día. Llevar contigo una botella de agua puede ser una excelente forma de recordarte que debes beber. Establece recordatorios en tu dispositivo o en tu espacio de trabajo para que cada hora tomes un momento para hidratarte. Esta práctica no solo mantiene tus niveles de hidratación en equilibrio, sino que también puede ayudar a evitar la sensación de sed intensa que puede aparecer si pasas mucho tiempo sin beber.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Control de Peso:</b> Una de las piedras angulares para mantener una hidratación óptima es consumir agua de manera constante a lo largo del día. Llevar contigo una botella de agua puede ser una excelente forma de recordarte que debes beber. Establece recordatorios en tu dispositivo o en tu espacio de trabajo para que cada hora tomes un momento para hidratarte. Esta práctica no solo mantiene tus niveles de hidratación en equilibrio, sino que también puede ayudar a evitar la sensación de sed intensa que puede aparecer si pasas mucho tiempo sin beber.</li><br>
                  <!---->

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>El Bienestar Mental Elevado</b></h1>
                  <p class="pb-3 text-justify text-white">El impacto del ejercicio va más allá de lo físico; también tiene un profundo efecto en tu salud mental y emocional:</p><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Liberación de Endorfinas: </b>El ejercicio estimula la liberación de endorfinas, neurotransmisores que mejoran el estado de ánimo y reducen el dolor. Experimentarás una sensación de euforia y bienestar después de una sesión de ejercicios.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Reducción del Estrés y la Ansiedad:</b> El ejercicio actúa como una válvula de escape para el estrés acumulado. Las actividades físicas liberan la tensión y promueven una sensación de calma y claridad mental.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Mejora del Sueño: </b> Las rutinas de ejercicio regulares ayudan a regular el ciclo del sueño. Disfrutarás de un sueño más profundo y reparador, lo que mejorará tu energía y concentración durante el día.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Aumento de la Autoestima: </b> Lograr objetivos de ejercicio y notar mejoras en tu cuerpo genera una sensación de logro y aumenta la confianza en uno mismo.</li><br>


                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>Integrando el Ejercicio en tu Vida Cotidiana</b></h1>
                  <p class="pb-3 text-justify text-white">Comenzar y mantener una rutina de ejercicio no es una tarea sencilla, pero es una inversión invaluable en tu bienestar. Aquí hay algunas estrategias prácticas para incorporar el ejercicio en tu vida diaria:</p><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Encuentra tu Pasión: </b>Elige una actividad física que disfrutes. Puede ser cualquier cosa, desde correr y nadar hasta yoga o baile. Disfrutarás más del proceso y serás más propenso a continuar.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Establece Metas Claras: </b>Define tus objetivos de ejercicio. ¿Quieres perder peso, aumentar la resistencia o simplemente sentirte más enérgico? Tener metas específicas te dará un propósito claro.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Diseña tu Horario: </b>Reserva tiempo para el ejercicio en tu calendario como lo harías con cualquier otra cita importante. Trátalo como una prioridad.</li><br>

                  <li class="text-justify text-white"><b style="color: #B0EE3C">Inicia con Moderación: </b>Si eres nuevo en el ejercicio, comienza con sesiones más cortas y de menor intensidad para evitar el agotamiento y las lesiones.</li><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>CONCLUSIÓN:</b></h1>
                  <p class="pb-3 text-justify text-white">La importancia de incorporar rutinas de ejercicio en nuestra vida es innegable. El ejercicio no solo nos brinda un cuerpo fuerte y saludable, sino que también tiene un impacto significativo en nuestro bienestar mental. La liberación de endorfinas, la reducción del estrés y la mejora del sueño son solo algunas de las maneras en que el ejercicio beneficia nuestra mente y emociones. A medida que exploramos maneras de integrar el ejercicio en nuestra rutina diaria, recordemos que cada paso hacia una vida más activa es un paso hacia un futuro más saludable, más equilibrado y más pleno.</p><br>
              </div>
          </article>

          <div class="w-full flex pt-2 pb-4">
              <a href="{{ route('enfermo') }}" class="w-1/2 bg-gray-900 rounded-l-lg shadow hover:shadow-md text-left p-6">
              ...
              <a href="{{ route('adaptarse') }}" class="w-1/2 bg-gray-900 rounded-r-lg shadow hover:shadow-md text-right p-6">
      ...
      <div class="w-full bg-gray-900 shadow flex flex-col rounded-lg my-4 p-6">
