...
<script>
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center pt-12 pb-2">
            <p class="font-bold  uppercase text-5xl" style="color: #B0EE3C">NUTRICIÓN INTELIGENTE</p>
            <p class="text-lg text-white">
              DESCUBRIENDO LOS FUNDAMENTOS DE UNA BUENA ALIMENTACIÓN
            </p>
        </div>
    </header>
    ...
    <div class="container  mx-auto flex flex-wrap py-6">
      ...
      <section class="w-full md:w-2/3 flex flex-col items-center px-3">
          ...
          <article class="flex flex-col shadow my-4">
              ...
              <a href="#" class="hover:opacity-75">
                  <img src="https://mariatrusa.org/wp-content/uploads/2022/11/Habitos-saludables-que-te-conduciran-a-una-vida-plena.jpg">
              </a>
              <div class="bg-gray-900 flex flex-col justify-start p-6">
                 ...
                 <p href="#" class="text-sm pb-8">
                  ...
                  <p class="pb-3 text-justify text-white">En un mundo lleno de información contradictoria sobre la alimentación, es esencial comprender los fundamentos de una buena nutrición. En este blog, exploraremos los principios clave para lograr una alimentación equilibrada y cómo tomar decisiones inteligentes en la búsqueda de una salud óptima.</p>
                  <br>
                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>VARIEDAD: LA CLAVE DE UNA DIETA BALANCEADA</b></h1>
                  <p class="pb-3 text-justify text-white">Una alimentación saludable se basa en la diversidad. Consumir una variedad de alimentos garantiza que recibamos una gama completa de nutrientes esenciales. Prioriza alimentos de todos los grupos: frutas, verduras, proteínas magras, granos enteros y productos lácteos bajos en grasa. Esta diversidad proporciona vitaminas, minerales y antioxidantes necesarios para el funcionamiento óptimo del cuerpo.</p><br>
                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>PROPORCIONES ADECUADAS: EL EQUILIBRIO ENTRE NUTRIENTES</b></h1>
                  <p class="pb-3 text-justify text-white">Lograr el equilibrio adecuado entre los nutrientes es esencial. Una guía útil es el "plato saludable": divide tu plato en porciones para incluir aproximadamente un 50% de verduras y frutas, un 25% de proteínas y un 25% de granos enteros. Esta proporción asegura una ingesta adecuada de carbohidratos, proteínas, grasas saludables, vitaminas y minerales.</p><br>
                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>HIDRATACIÓN: EL PODER DEL AGUA</b></h1>
                  <p class="pb-3 text-justify text-white">El agua es esencial para todas las funciones del cuerpo. Mantente hidratado bebiendo agua a lo largo del día. Evita las bebidas azucaradas y refrescos, ya que pueden añadir calorías vacías a tu dieta.</p><br>
                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>CONTROL DE PORCIONES: CALIDAD SOBRE CANTIDAD</b></h1>
                  <p class="pb-3 text-justify text-white">El tamaño de las porciones juega un papel crucial en el control del peso. Conciencia tus porciones y escucha las señales de hambre y saciedad de tu cuerpo. Evita comer en exceso y practica la moderación.</p><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>LIMITAR AZÚCARES Y GRASAS NO SALUDABLES</b></h1>
                  <p class="pb-3 text-justify text-white">Educarte sobre la nutrición es fundamental para tomar decisiones informadas. Comprende la información nutricional en las etiquetas de los alimentos y busca fuentes confiables para aprender sobre los alimentos que consumes.</p><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>PLANIFICACIÓN DE COMIDAS: PREPARACIÓN PARA EL ÉXITO</b></h1>
                  <p class="pb-3 text-justify text-white">La planificación de comidas te ayuda a evitar decisiones apresuradas y poco saludables. Organiza tus comidas y meriendas con anticipación para asegurarte de que tu dieta sea equilibrada y nutritiva.</p><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>CONTROL DE PORCIONES: CALIDAD SOBRE CANTIDAD</b></h1>
                  <p class="pb-3 text-justify text-white">El tamaño de las porciones juega un papel crucial en el control del peso. Conciencia tus porciones y escucha las señales de hambre y saciedad de tu cuerpo. Evita comer en exceso y practica la moderación.</p><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>CONTROL DE PORCIONES: CALIDAD SOBRE CANTIDADDESARROLLO DE HÁBITOS: CAMBIOS SOSTENIBLES CON EL TIEMPO</b></h1>
                  <p class="pb-3 text-justify text-white">Una alimentación saludable no se trata solo de una dieta temporal, sino de hábitos sostenibles. Realiza cambios gradualmente y permite que se conviertan en parte de tu estilo de vida a largo plazo.</p><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>ESCUCHA A TU CUERPO: SEÑALES DE HAMBRE Y SACIEDAD</b></h1>
                  <p class="pb-3 text-justify text-white">Aprende a escuchar las señales de tu cuerpo. Come cuando tengas hambre y detente cuando estés satisfecho. Prestar atención a tus necesidades te ayudará a evitar comer en exceso.</p><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>CONSULTA PROFESIONAL: APOYO DE EXPERTOS EN NUTRICIÓN</b></h1>
                  <p class="pb-3 text-justify text-white">Si tienes preguntas específicas o necesitas orientación personalizada, no dudes en consultar a un profesional de la nutrición. Ellos pueden proporcionarte un plan adaptado a tus necesidades y objetivos.</p><br>

                  <h1 class="text-2xl font-bold pb-3" style="color: #B0EE3C"><b>CONCLUSIÓN:</b></h1>
                  <p class="pb-3 text-justify text-white">Una buena alimentación es un pilar fundamental para una vida saludable y llena de energía. Al comprender los principios básicos de la nutrición y adoptar hábitos informados, puedes tomar el control de tu salud y bienestar. Recuerda que cada elección alimentaria importa y que pequeños cambios pueden tener un impacto duradero en tu calidad de vida.</p><br>

              </div>
          </article>

          <div class="w-full flex pt-2 pb-4">
              <a href="{{ route('cuidados') }}" class="w-1/2 bg-gray-900 rounded-l-lg shadow hover:shadow-md text-left p-6">
              ...
              <a href="{{ route('vacunacion') }}" class="w-1/2 bg-gray-900 rounded-r-lg shadow hover:shadow-md text-right p-6">
      ...
      <div class="w-full bg-gray-900 shadow rounded-lg flex flex-col my-4 p-6">
